...
// 	uint32_t enable_ub_mesh;  // flag to enable UB mesh topology routing (per RdmaHw instance)
...
// 	// Debug helper: dump routing tables (standard + nvSwitch) for this RdmaHw instance
